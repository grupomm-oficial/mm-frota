...
function Card({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="card"
      className={cn(
        "bg-card text-card-foreground app-hover-lift flex min-w-0 max-w-full flex-col gap-6 rounded-[28px] border border-border py-6 shadow-[0_14px_34px_rgba(15,23,42,0.05)]",
        className
      )}
      {...props}
    />
